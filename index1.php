...
$url = 'https://agora-node-tokenserver.chimeddorzhlut1.repl.co/access_token?channelName=test';
$json = file_get_contents($url);
// Convert to array 
$array = json_decode($json);

$array = json_decode($array, true);
$trprice=$array["trade"]["ZESCMNT"]["price"];
...
<body data-spy="scroll" data-target=".main-menubar">
    <!--preloader-->
                            ...
                            <div class="hero-section-details mb-30" data-aos="fade" data-aos-delay="500">
                                ...
                                <div class="hero-btn d-flex flex-wrap mt-40" data-aos="fade-up" data-aos-delay="600">
                                    <a href="/cooperation.pdf"
                                        class="btn btn-lg gradient-btn rounded-50 mr-20 mb-10 hvr-shutter-out-horizontal">Зар
                                        сурталчилгаа</a>
                                    <a href="#try_app"
                ...
                <div class="container" id="token">
                    <div class="pricing-table-head d-flex justify-content-between flex-wrap">
                        ...
                        <p>Арилжаалагдаж буй биржүүд
                            <br> <span>Trade.mn, Complex.mn</span></p>
                        ...
                        <div class="row">
                                ...
                                <div class="single-price-details mb-md-20 mb-lg-0" data-aos="fade-up"
                                    ...
                                    <div class="single-Price text-center">
                                        <div class="coin-type">
                                            ...
                                            <a href="https://trade.mn/exchange/ZESC/MNT">
                                                <img src="assets/img/logo/trade.png" alt="cryptocoin image">
                                            </a>
                                            ...
                                            <div class="coin-price-rate d-flex justify-content-between flex-wrap">
                                                <div class="rate">
                                                    <h6>Ханш</h6>
                                                    <span id="trprice"> <?php echo  $trprice; ?> ₮</span>
                                                </div>
                                                <div class="rate">
                                                    <h6>Өөрчлөлт </h6>
                                                    <span id="trpre">(<?php echo  $trpre; ?>)</span>
                                                </div>
                                                <!-- <div class="rate">
                                                    <h6>Доод</h6>
                                                    <span>5.84 ₮</span>
                                        ...
                                        <div class="rate-fluctuation text-left">
                                            <p>ZESC - MNT </p>
                                            <div
                                                class="price d-flex justify-content-between align-items-center flex-wrap">

                                                <span> 24 цаг нийт: </span>
                                                <span id="trtotal"><?php echo  $trtotal; ?> </span> <span>ш</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="single-price-details mb-md-20 mb-lg-0" data-aos="fade-up"
                                    ...
                                    <div class="single-Price text-center">
                                        <div class="coin-type">
                                            <a href="https://complex.mn/">
                                                <img style="height: 57px; width: 57px;"
                                                    src="assets/img/logo/complex.png" alt="cryptocoin image">
                                            </a>
                                            ...
                                            <div class="coin-price-rate d-flex justify-content-between flex-wrap">
                                                <div class="rate">
                                                    <h6>Ханш</h6>
                                                    <span id="trprice"> <?php echo  $comprice[0]; ?> ₮</span>
                                                </div>
                                                <div class="rate">
                                                    <h6>Өөрчлөлт </h6>
                                                    <span id="trpre">(<?php echo  $compre; ?>)</span>
                                                </div>
                                                <!-- <div class="rate">
                                                    <h6>Доод</h6>
                                                    <span>5.84 ₮</span>
                                        ...
                                        <div class="rate-fluctuation text-left">
                                            ...
                                            <div
                                                ...
                                                <span> 24 цаг нийт: </span>
                                                <span id="trtotal"> <?php echo  $comtotal; ?></span> <span>ш</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="single-price-details mb-md-20 mb-lg-0" data-aos="fade-up"
                                    ...
                                    <div class="single-Price text-center">
                                        <div class="coin-type">
                                            <a href="#https://capex.mn/">
                                                <img style="height: 57px; width: 57px;" src="assets/img/logo/capex.png"
                                            ...
                                            <div class="coin-price-rate d-flex justify-content-between flex-wrap">
                                                <div class="rate">
                                                    <h6>Ханш</h6>
                                                    <span id="trprice">00.00 ₮</span>
                                                </div>
                                                <div class="rate">
                                                    <h6>Өөрчлөлт </h6>
                                                    <span id="trpre">(00.00%)</span>
                                                </div>
                                                <!-- <div class="rate">
                                                    <h6>Доод</h6>
                                                    <span>5.84 ₮</span>
                                        ...
                                        <div class="rate-fluctuation text-left">
                                            ...
                                            <div
                                                ...
                                                <span> 24 цаг нийт: </span>
                                                <span id="trtotal"> </span> <span>ш</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="single-price-details mb-md-20 mb-lg-0" data-aos="fade-up"
                                    ...
                                    <div class="single-Price text-center">
                                        <div class="coin-type">
                                            <a href="#">
                                                <img style="width: 57px;" src="assets/img/logo/zesc.png"
                                                    alt="cryptocoin image">
                                            </a>
                                            <div class="coin-name my-20">
                                                <h3>ТУН УДАХГҮЙ</h3>
