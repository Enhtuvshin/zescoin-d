                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                <form action="code.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" value="<?=$student['numbers1'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Student Phone</label>
                                        <input type="text" name="phone" value="<?=$student['numbers2'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label>Student Course</label>
                                        <input type="text" name="course" value="<?=$student['numbers3'];?>" class="form-control">
                                    </div>
                                    <div class="mb-3">
